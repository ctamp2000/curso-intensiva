...
export default function Header({ onNavigate }) {
  ...
  return (
    <header className="w-full" role="banner">
      ...
      {/* Top banner */}
      <div className="bg-brand-primary px-4 sm:px-6 md:px-8 py-4 flex flex-col lg:flex-row items-center justify-between gap-4">
